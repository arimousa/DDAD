    ...
    if config.data.name == 'cifar10':
        with torch.no_grad():
            for data, labels in testloader:
                ...
                reconstructed, rec_x0 = my_generalized_steps(data, noisy_image, seq, unet, constants_dict['betas'], config, gama= cr, constants_dict=constants_dict ,eraly_stop = False)
