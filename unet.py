...
#         up_channels_1 = (1024, 512, 256)
#         up_channels_2 = (256, 128, 64)
#         out_dim = 1 
#         time_emb_dim = 32
...
#         self.conv1 = nn.Conv2d(up_channels_1[-2], up_channels_1[-1], 3, padding=1)
...
#         # Upsample
#         self.ups_1 = nn.ModuleList([Block(2*up_channels_1[i], up_channels_1[i+1], \
#                                         time_emb_dim, up=True) \
#                     for i in range(len(up_channels_1)-1)])
#         self.ups_2 = nn.ModuleList([Block(up_channels_2[i], up_channels_2[i+1], \
#                                         time_emb_dim, up=True) \
#                     for i in range(len(up_channels_2)-1)])

#         self.output = nn.Conv2d(up_channels_2[-1], image_channels, out_dim)
...
#         y = self.conv0(y)     #Option2: just y-x 
#         # Unet
#         residual_inputs_x = []
#         residual_inputs_y = []
...
#             x = down(x, t)
#             y = down(y, t)
#             residual_inputs_x.append(x)
#             residual_inputs_y.append(y)
#         # print('x shape : ',x.shape)
#         # print('y shape : ',y.shape)
#         # y = torch.cat((x, y), dim=1)
#         # y = self.conv1(y)
#         # y = y-x
#         # print('y 2 shape : ',y.shape)
#         for up in self.ups_1:
#             residual_y = residual_inputs_y.pop()
#             residual_x = residual_inputs_x.pop()
#             # Add residual x as additional channels
#             y = torch.cat((y, residual_y), dim=1)   
...
#         y = self.conv1(y)
#         # y = y-x
#         # print('y shape after 2: ',y.shape)
#         for up in self.ups_2:
